...
<section id="home" class="box">
    <div class="container">
        <div class="panel">
		    ...
		    <div class="row-fluid">
			<div class="span12">
<p>LDE is a London based commodities brokerage, specialising in high-performance, medium-risk alternative investment vehicles. We can draw upon the wealth of experience within our team, with backgrounds in commodity, equity, bond and financial advisory markets. With all of our products our aim is deliver wholesale, institutional prices to private, retail clients.</p>
			</div>
		    </div>
                    <div class="row-fluid">
                        <div class="span2">
